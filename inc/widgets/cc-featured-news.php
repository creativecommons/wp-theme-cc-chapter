	...
	function widget( $args, $instance ) {
		...
		<section class="widget featured-news <?php print $cc_featured_news_theme; ?> num-cols-<?php echo $cc_featured_news_numposts; ?>">
			<div class="widget-wrapper">
				<header>
					<?php
					if ( $cc_featured_news_title ) {
						?>
						<h2><?php print $cc_featured_news_title; ?></h2><?php } ?>
					<?php
					if ( $cc_featured_news_description ) {
						?>
						<div class="widget-description"><?php print $cc_featured_news_description; ?></div><div style="clear:both;"></div><?php } ?>
				</header>
				<?php
				// The hero feature
				// START BACK HERE...
						...
						<article class="hero">
							<div class="item">
								...
								<div class="teaser">
									...
									<?php $add_style = ($cc_featured_news_hero_content_display == 'hide') ? 'style="display:none;"': ''; ?>
									<div class="excerpt" <?php echo $add_style; ?> >
									<?php
									if ( $cc_featured_news_hero_content_display == 'excerpt' ) {
										print the_excerpt(); 
									} else {
										print the_content(); 
									}
									...
									<?php
									if ( $cc_featured_news_post_read_more ) {
										?>
										<div class="more"><a href="<?php print $url; ?>"><?php print $cc_featured_news_post_read_more; ?></a></div><?php } ?>
								</div>
							</div>
						</article>
					<?php } ?>
						...
						?>
							<article>
								...
								<div class="thumbnail ratio_<?php print $cc_featured_news_aspect_ratio; ?>" style="background-image:url(<?php print the_post_thumbnail_url( 'large' ); ?>)">
									...
									<div class="teaser">
										<h3 class="title"><a href="<?php print $url; ?>"><?php print get_the_title(); ?></a></h3>
										<?php $add_style = ($cc_featured_news_content_display == 'hide') ? 'style="display:none;"': ''; ?>
										<div class="excerpt" <?php echo $add_style; ?> >
										<?php
										if ( $cc_featured_news_content_display == 'excerpt' ) {
											print the_excerpt(); 
										} else {
											print the_content(); 
										}
										...
										if ( $cc_featured_news_post_read_more ) {
											?>
											<div class="more"><a href="<?php print $url; ?>"><?php print $cc_featured_news_post_read_more; ?></a></div>
										<?php } ?>
									</div>
								</div>
							</article>
				...
				<?php
				if ( $cc_featured_news_more ) {
					?>
					<div class="more"><a href="/?post_type=post"><?php print $cc_featured_news_more; ?><i class="cc-icon-right-dir"></i></a></div><?php } ?>
			</div>
		</section>
