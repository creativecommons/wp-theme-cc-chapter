	...
	function widget( $args, $instance ) {
		...
		<section class="featured-programs widget  num-cols-<?php echo $cc_programs_numposts; ?>  <?php echo $noheader; ?>">
			...
			if ( ! $noheader ) {
				...
				<header>
					<?php
					if ( $cc_programs_title ) {
						?>
						<h2><?php print $cc_programs_title; ?></h2><?php } ?>
					<?php
					if ( $cc_programs_description ) {
						?>
						<div class="widget-description"><?php print $cc_programs_description; ?></div><div style="clear:both;"></div><?php } ?>
				</header>
			<?php } ?>
					...
					<article>
						<div class="item">
							...
							<div class="teaser">
                                ...
                                <?php $add_style = ($cc_programs_content_display == 'hide') ? 'style="display:none;"': ''; ?>
								<div class="excerpt" <?php echo $add_style; ?> >
                                <?php
                                if ( $cc_programs_content_display == 'excerpt' ) {
                                    print the_excerpt(); 
                                } else {
                                    print the_content(); 
                                }
								...
								<?php
								if ( $cc_programs_post_read_more ) {
									?>
									<div class="more"><a href="<?php print $url; ?>"><?php print $cc_programs_post_read_more; ?></a></div><?php } ?>
							</div>
						</div>
					</article>
					<?php
			...
			if ( $cc_programs_more ) {
				?>
				<div class="more"><a href="/?post_type=post"><?php print $cc_programs_more; ?><i class="cc-icon-right-dir"></i></a></div><?php } ?>
		</section>
