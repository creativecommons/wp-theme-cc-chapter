...
<section class="whats-new featured <?php print $cc_home_whats_happening_theme; ?> num-cols-<?php echo $cc_home_whats_happening_numposts;?>">
	<header>
		<?php if($cc_home_whats_happening_title) { ?><h2><?php print $cc_home_whats_happening_title; ?></h2><?php } ?>
		<?php if($cc_home_whats_happening_description){ ?><div class="widget-description"><?php print $cc_home_whats_happening_description; ?></div><div style="clear:both;"></div><?php } ?>
	</header>
		<?php
		// The hero feature
		...
		<article class="hero">
			<div class="item">
				...
				<div class="teaser">
					...
					<div class="excerpt" <?php if($cc_home_whats_happening_hero_content_display == 'hide'){ ?> style="display:none;" <?php } ?>><?php 
						if($cc_home_whats_happening_hero_content_display == 'excerpt'){ print the_excerpt(); } 
						else { print the_content(); } ?>
					</div>
					<?php if($cc_home_whats_happening_post_read_more) { ?><div class="more"><a href="<?php print $url; ?>"><?php print $cc_home_whats_happening_post_read_more; ?></a></div><?php } ?>
				</div>
			</div>
		</article>
			<?php } ?>
	...
	?>
		<article>
			...
			<div class="thumbnail ratio_<?php print $cc_home_whats_happening_aspect_ratio; ?>" style="background-image:url(<?php print the_post_thumbnail_url('large'); ?>)">
				...
				<div class="teaser">
					<h3 class="title"><a href="<?php print $url; ?>"><?php print get_the_title() ?></a></h3>
					<div class="excerpt" <?php if($cc_home_whats_happening_content_display == 'hide'){ ?> style="display:none;" <?php } ?>><?php 
						if($cc_home_whats_happening_content_display == 'excerpt'){ print the_excerpt(); } 
						else { print the_content(); } ?>
					</div>
					<?php if($cc_home_whats_happening_post_read_more) { ?><div class="more"><a href="<?php print $url; ?>"><?php print $cc_home_whats_happening_post_read_more; ?></a></div><?php } ?>
				</div>
	...
	<?php if($cc_home_whats_happening_more) { ?><div class="more"><a href="/?post_type=post"><?php print $cc_home_whats_happening_more; ?><i class="cc-icon-right-dir"></i></a></div><?php } ?>
</section>
...
// TITLE
	if( isset( $instance[ 'cc_home_whats_happening_title' ] ) ) {
						$cc_home_whats_happening_title = $instance[ 'cc_home_whats_happening_title' ];} 
	else {				$cc_home_whats_happening_title = __( '', 'wpb_widget_domain' );}
	// DESCRIPTION
	if( isset( $instance[ 'cc_home_whats_happening_description' ] ) ) {
						$cc_home_whats_happening_description = $instance[ 'cc_home_whats_happening_description' ];} 
	else {				$cc_home_whats_happening_description = __( '', 'wpb_widget_domain' ); }
	//MORE ARTICLES
	if( isset( $instance[ 'cc_home_whats_happening_more' ] ) ) {
						$cc_home_whats_happening_more = $instance[ 'cc_home_whats_happening_more' ]; } 
	else {				$cc_home_whats_happening_more = __( '', 'wpb_widget_domain' ); }
	//READ MORE
	if( isset( $instance[ 'cc_home_whats_happening_post_read_more' ])){	
						$cc_home_whats_happening_post_read_more = $instance[ 'cc_home_whats_happening_post_read_more' ];} 
	else {				$cc_home_whats_happening_post_read_more = __( '', 'wpb_widget_domain' ); }
//Repeat for number of posts
	...
	else {				$cc_home_whats_happening_numposts = __( '3', 'wpb_widget_domain' );}      
//CATEGORY
	...
	else {	            $cc_home_whats_happening_category = __( '', 'wpb_widget_domain' );}
//show excerpt
	...
	else {				$cc_home_whats_happening_show_excerpt = __( '', 'wpb_widget_domain' );}
//Content Display Type
	...
	else {				$cc_home_whats_happening_content_display = __( 'excerpt', 'wpb_widget_domain' );}     
	...
	else {				$cc_home_whats_happening_hero_content_display = __( 'excerpt', 'wpb_widget_domain' );}	  
// Image Ratio
	...
	else {				$cc_home_whats_happening_aspect_ratio = __( '3_2', 'wpb_widget_domain' );}
// Widget Title
