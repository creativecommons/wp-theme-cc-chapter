   ...
   */
	function widget( $args, $instance ) {
        ...
        <?php 
            if(!$noheader){ ?>
            <header>
                <?php if($cc_links_title) { ?><h2><?php print $cc_links_title; ?></h2><?php } ?>
                <?php if($cc_links_description){ ?><div class="widget-description"><?php print $cc_links_description; ?></div><div style="clear:both;"></div><?php } ?>
            </header>
            <?php } ?>
